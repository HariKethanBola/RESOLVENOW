...
This folder contains all the official documentation and reports related to the **ResolveNow** project.

## 📂 Files Included:

- **Project Documentation.docx** – Detailed write-up of the entire project, including use case, system architecture, and features.
- **Project Documentation.pdf** – PDF version of the above document for easier viewing.
